...
function getLockTypeCodec() {
  return combineCodec3(getLockTypeEncoder(), getLockTypeDecoder());
}
...
function getLockTypeLabelCodec() {
  return combineCodec4(getLockTypeLabelEncoder(), getLockTypeLabelDecoder());
}
...
function getTickCodec() {
  return combineCodec8(getTickEncoder(), getTickDecoder());
}
...
function getLockConfigDiscriminatorBytes() {
  return fixEncoderSize2(getBytesEncoder2(), 8).encode(LOCK_CONFIG_DISCRIMINATOR);
}
function getLockConfigEncoder() {
  return transformEncoder2(
    getStructEncoder7([
      ["discriminator", fixEncoderSize2(getBytesEncoder2(), 8)],
      ["position", getAddressEncoder3()],
      ["positionOwner", getAddressEncoder3()],
      ["whirlpool", getAddressEncoder3()],
      ["lockedTimestamp", getU64Encoder2()],
...
function getLockConfigDecoder() {
  return getStructDecoder7([
    ...
    ["position", getAddressDecoder3()],
    ["positionOwner", getAddressDecoder3()],
    ["whirlpool", getAddressDecoder3()],
    ["lockedTimestamp", getU64Decoder2()],
    ["lockType", getLockTypeLabelDecoder()]
  ]);
}
function getLockConfigCodec() {
  return combineCodec10(getLockConfigEncoder(), getLockConfigDecoder());
}
...
function getPositionDiscriminatorBytes() {
  return fixEncoderSize3(getBytesEncoder3(), 8).encode(POSITION_DISCRIMINATOR);
}
...
function getPositionCodec() {
  return combineCodec11(getPositionEncoder(), getPositionDecoder());
}
...
function getPositionBundleEncoder() {
  return transformEncoder4(
    getStructEncoder9([
      ...
      ["positionBundleMint", getAddressEncoder5()],
      ["positionBitmap", fixEncoderSize4(getBytesEncoder4(), 32)]
    ]),
...
function getPositionBundleDecoder() {
  return getStructDecoder9([
    ...
    ["positionBundleMint", getAddressDecoder5()],
    ["positionBitmap", fixDecoderSize4(getBytesDecoder4(), 32)]
  ]);
}
function getPositionBundleCodec() {
  return combineCodec12(getPositionBundleEncoder(), getPositionBundleDecoder());
}
...
function getTickArrayDiscriminatorBytes() {
  return fixEncoderSize5(getBytesEncoder5(), 8).encode(TICK_ARRAY_DISCRIMINATOR);
}
...
function getTickArrayCodec() {
  return combineCodec13(getTickArrayEncoder(), getTickArrayDecoder());
}
...
function getTokenBadgeDiscriminatorBytes() {
  return fixEncoderSize6(getBytesEncoder6(), 8).encode(TOKEN_BADGE_DISCRIMINATOR);
}
...
function getTokenBadgeDecoder() {
  return getStructDecoder11([
    ...
    ["tokenMint", getAddressDecoder7()]
  ]);
}
function getTokenBadgeCodec() {
  return combineCodec14(getTokenBadgeEncoder(), getTokenBadgeDecoder());
}
...
function getWhirlpoolDiscriminatorBytes() {
  return fixEncoderSize7(getBytesEncoder7(), 8).encode(WHIRLPOOL_DISCRIMINATOR);
}
function getWhirlpoolEncoder() {
  return transformEncoder7(
    getStructEncoder12([
      ["discriminator", fixEncoderSize7(getBytesEncoder7(), 8)],
      ["whirlpoolsConfig", getAddressEncoder8()],
      ["whirlpoolBump", fixEncoderSize7(getBytesEncoder7(), 1)],
      ["tickSpacing", getU16Encoder2()],
      ["tickSpacingSeed", fixEncoderSize7(getBytesEncoder7(), 2)],
      ...
      ["protocolFeeOwedA", getU64Encoder4()],
      ["protocolFeeOwedB", getU64Encoder4()],
      ["tokenMintA", getAddressEncoder8()],
      ["tokenVaultA", getAddressEncoder8()],
      ["feeGrowthGlobalA", getU128Encoder5()],
      ["tokenMintB", getAddressEncoder8()],
      ["tokenVaultB", getAddressEncoder8()],
      ["feeGrowthGlobalB", getU128Encoder5()],
      ["rewardLastUpdatedTimestamp", getU64Encoder4()],
      [
        "rewardInfos",
...
function getWhirlpoolDecoder() {
  return getStructDecoder12([
    ...
    ["whirlpoolsConfig", getAddressDecoder8()],
    ["whirlpoolBump", fixDecoderSize7(getBytesDecoder7(), 1)],
    ["tickSpacing", getU16Decoder2()],
    ["tickSpacingSeed", fixDecoderSize7(getBytesDecoder7(), 2)],
    ...
    ["protocolFeeOwedA", getU64Decoder4()],
    ["protocolFeeOwedB", getU64Decoder4()],
    ["tokenMintA", getAddressDecoder8()],
    ["tokenVaultA", getAddressDecoder8()],
    ["feeGrowthGlobalA", getU128Decoder5()],
    ["tokenMintB", getAddressDecoder8()],
    ["tokenVaultB", getAddressDecoder8()],
    ["feeGrowthGlobalB", getU128Decoder5()],
    ["rewardLastUpdatedTimestamp", getU64Decoder4()],
    [
      "rewardInfos",
...
function getWhirlpoolCodec() {
  return combineCodec15(getWhirlpoolEncoder(), getWhirlpoolDecoder());
}
...
function getWhirlpoolsConfigEncoder() {
  return transformEncoder8(
    getStructEncoder13([
      ...
      ["feeAuthority", getAddressEncoder9()],
      ["collectProtocolFeesAuthority", getAddressEncoder9()],
      ["rewardEmissionsSuperAuthority", getAddressEncoder9()],
...
function getWhirlpoolsConfigDecoder() {
  return getStructDecoder13([
    ...
    ["feeAuthority", getAddressDecoder9()],
    ["collectProtocolFeesAuthority", getAddressDecoder9()],
    ["rewardEmissionsSuperAuthority", getAddressDecoder9()],
...
function getWhirlpoolsConfigExtensionEncoder() {
  return transformEncoder9(
    getStructEncoder14([
      ...
      ["configExtensionAuthority", getAddressEncoder10()],
      ["tokenBadgeAuthority", getAddressEncoder10()]
    ]),
    (value) => ({
      ...value,
...
function getWhirlpoolsConfigExtensionDecoder() {
  return getStructDecoder14([
    ...
    ["configExtensionAuthority", getAddressDecoder10()],
    ["tokenBadgeAuthority", getAddressDecoder10()]
  ]);
}
...
function getCollectFeesInstructionDataEncoder() {
  return transformEncoder13(
    getStructEncoder18([["discriminator", fixEncoderSize14(getBytesEncoder14(), 8)]]),
...
function getDecreaseLiquidityV2InstructionDataEncoder() {
  return transformEncoder20(
    getStructEncoder25([
      ...
      ["tokenMinA", getU64Encoder6()],
      ["tokenMinB", getU64Encoder6()],
      [
        "remainingAccountsInfo",
...
function getDecreaseLiquidityV2InstructionDataDecoder() {
  return getStructDecoder25([
    ...
    ["tokenMinA", getU64Decoder6()],
    ["tokenMinB", getU64Decoder6()],
    [
      "remainingAccountsInfo",
...
function getDeleteTokenBadgeInstructionDataEncoder() {
  return transformEncoder22(
    getStructEncoder27([["discriminator", fixEncoderSize23(getBytesEncoder23(), 8)]]),
...
function getIncreaseLiquidityV2InstructionDataEncoder() {
  return transformEncoder24(
    getStructEncoder29([
      ...
      ["tokenMaxA", getU64Encoder8()],
      ["tokenMaxB", getU64Encoder8()],
      [
        "remainingAccountsInfo",
...
function getIncreaseLiquidityV2InstructionDataDecoder() {
  return getStructDecoder29([
    ...
    ["tokenMaxA", getU64Decoder8()],
    ["tokenMaxB", getU64Decoder8()],
    [
      "remainingAccountsInfo",
...
function getInitializeTokenBadgeInstructionDataEncoder() {
  return transformEncoder35(
    getStructEncoder40([["discriminator", fixEncoderSize36(getBytesEncoder36(), 8)]]),
    (value) => ({
      ...value,
...
function getSetConfigExtensionAuthorityInstructionDataEncoder() {
  return transformEncoder42(
    getStructEncoder47([["discriminator", fixEncoderSize43(getBytesEncoder43(), 8)]]),
    (value) => ({
      ...value,
...
function getSetFeeAuthorityInstructionDataEncoder() {
  return transformEncoder45(
    getStructEncoder50([["discriminator", fixEncoderSize46(getBytesEncoder46(), 8)]]),
...
function getSwapDiscriminatorBytes() {
  return fixEncoderSize55(getBytesEncoder55(), 8).encode(SWAP_DISCRIMINATOR);
}
...
function getSwapV2DiscriminatorBytes() {
  return fixEncoderSize56(getBytesEncoder56(), 8).encode(SWAP_V2_DISCRIMINATOR);
}
...
function getUpdateFeesAndRewardsInstructionDataEncoder() {
  return transformEncoder58(
    getStructEncoder63([["discriminator", fixEncoderSize59(getBytesEncoder59(), 8)]]),
    (value) => ({
      ...value,
...
function feeTierWhirlpoolsConfigFilter(address) {
  return {
    memcmp: {
      offset: 8n,
      bytes: getBase58Decoder().decode(getAddressEncoder12().encode(address)),
      encoding: "base58"
    }
  };
}
...
function positionWhirlpoolFilter(address) {
  return {
    memcmp: {
      offset: 8n,
      bytes: getBase58Decoder2().decode(getAddressEncoder13().encode(address)),
      encoding: "base58"
    }
  };
}
...
import { getAddressEncoder as getAddressEncoder14, getBase58Decoder as getBase58Decoder3 } from "@solana/kit";
function positionBundleMintFilter(address) {
  return {
    memcmp: {
      offset: 8n,
      bytes: getBase58Decoder3().decode(getAddressEncoder14().encode(address)),
      encoding: "base58"
    }
  };
}
...
function tickArrayWhirlpoolFilter(address) {
  return {
    memcmp: {
      offset: 9956n,
      bytes: getBase58Decoder4().decode(getAddressEncoder15().encode(address)),
      encoding: "base58"
    }
  };
}
...
import { getBase58Decoder as getBase58Decoder5, getAddressEncoder as getAddressEncoder16 } from "@solana/kit";
function tokenBadgeWhirlpoolsConfigFilter(address) {
  return {
    memcmp: {
      offset: 8n,
      bytes: getBase58Decoder5().decode(getAddressEncoder16().encode(address)),
      encoding: "base58"
    }
  };
}
...
function whirlpoolWhirlpoolConfigFilter(address) {
  return {
    memcmp: {
      offset: 8n,
      bytes: getBase58Decoder6().decode(getAddressEncoder17().encode(address)),
      encoding: "base58"
    }
  };
}
...
function whirlpoolTokenMintAFilter(tokenMintA) {
  return {
    memcmp: {
      offset: 101n,
      bytes: getBase58Decoder6().decode(getAddressEncoder17().encode(tokenMintA)),
      encoding: "base58"
    }
  };
}
function whirlpoolTokenVaultAFilter(tokenVaultA) {
  return {
    memcmp: {
      offset: 133n,
      bytes: getBase58Decoder6().decode(getAddressEncoder17().encode(tokenVaultA)),
      encoding: "base58"
    }
  };
}
function whirlpoolTokenMintBFilter(tokenMintB) {
  return {
    memcmp: {
      offset: 181n,
      bytes: getBase58Decoder6().decode(getAddressEncoder17().encode(tokenMintB)),
      encoding: "base58"
    }
  };
}
function whirlpoolTokenVaultBFilter(tokenVaultB) {
  return {
    memcmp: {
      offset: 213n,
      bytes: getBase58Decoder6().decode(getAddressEncoder17().encode(tokenVaultB)),
      encoding: "base58"
    }
  };
}
function whirlpoolRewardMint1Filter(rewardMint1) {
  return {
    memcmp: {
      offset: 269n,
      bytes: getBase58Decoder6().decode(getAddressEncoder17().encode(rewardMint1)),
      encoding: "base58"
    }
  };
}
  ...
  return {
    memcmp: {
      ...
      bytes: getBase58Decoder6().decode(
        getAddressEncoder17().encode(rewardVault1)
      ),
      encoding: "base58"
    }
  };
...
function whirlpoolRewardMint2Filter(rewardMint2) {
  return {
    memcmp: {
      offset: 397n,
      bytes: getBase58Decoder6().decode(getAddressEncoder17().encode(rewardMint2)),
      encoding: "base58"
    }
  };
}
function whirlpoolRewardVault2Filter(rewardVault2) {
  return {
    memcmp: {
      offset: 429n,
      bytes: getBase58Decoder6().decode(
        getAddressEncoder17().encode(rewardVault2)
      ),
      encoding: "base58"
    }
  };
...
function whirlpoolRewardMint3Filter(rewardMint3) {
  return {
    memcmp: {
      offset: 525n,
      bytes: getBase58Decoder6().decode(getAddressEncoder17().encode(rewardMint3)),
      encoding: "base58"
    }
  };
}
function whirlpoolRewardVault3Filter(rewardVault3) {
  return {
    memcmp: {
      offset: 557n,
      bytes: getBase58Decoder6().decode(
        getAddressEncoder17().encode(rewardVault3)
      ),
      encoding: "base58"
    }
  };
  ...
  return {
    memcmp: {
      ...
      bytes: getBase58Decoder7().decode(
        getAddressEncoder18().encode(feeAuthority)
      ),
      encoding: "base58"
    }
  };
...
function whirlpoolsConfigCollectProtocolFeesAuthorityFilter(collectProtocolFeesAuthority) {
  return {
    memcmp: {
      offset: 40n,
      bytes: getBase58Decoder7().decode(
        getAddressEncoder18().encode(collectProtocolFeesAuthority)
      ),
      encoding: "base58"
    }
  };
...
function whirlpoolsConfigRewardEmissionsSuperAuthorityFilter(rewardEmissionsSuperAuthority) {
  return {
    memcmp: {
      offset: 72n,
      bytes: getBase58Decoder7().decode(
        getAddressEncoder18().encode(rewardEmissionsSuperAuthority)
      ),
      encoding: "base58"
    }
  };
...
import { getBase58Decoder as getBase58Decoder8, getAddressEncoder as getAddressEncoder19 } from "@solana/kit";
function whirlpoolsConfigExtensionWhirlpoolsConfigFilter(address) {
  return {
    memcmp: {
      offset: 8n,
      bytes: getBase58Decoder8().decode(getAddressEncoder19().encode(address)),
      encoding: "base58"
    }
  };
}
  ...
  return {
    memcmp: {
      ...
      bytes: getBase58Decoder8().decode(
        getAddressEncoder19().encode(configExtensionAuthority)
      ),
      encoding: "base58"
    }
  };
...
function whirlpoolsConfigExtensionConfigTokenBadgeAuthorityFilter(configTokenBadgeAuthority) {
  return {
    memcmp: {
      offset: 72n,
      bytes: getBase58Decoder8().decode(
        getAddressEncoder19().encode(configTokenBadgeAuthority)
      ),
      encoding: "base58"
    }
  };
...
async function getFeeTierAddress(whirlpoolsConfig, tickSpacing) {
  return await getProgramDerivedAddress({
    ...
    seeds: [
      "fee_tier",
      getAddressEncoder20().encode(whirlpoolsConfig),
...
// src/pda/oracle.ts
import { getAddressEncoder as getAddressEncoder21, getProgramDerivedAddress as getProgramDerivedAddress2 } from "@solana/kit";
async function getOracleAddress(whirlpool) {
  return await getProgramDerivedAddress2({
    programAddress: WHIRLPOOL_PROGRAM_ADDRESS,
    seeds: ["oracle", getAddressEncoder21().encode(whirlpool)]
  });
}

// src/pda/position.ts
import { getAddressEncoder as getAddressEncoder22, getProgramDerivedAddress as getProgramDerivedAddress3 } from "@solana/kit";
async function getPositionAddress(positionMint) {
  return await getProgramDerivedAddress3({
    programAddress: WHIRLPOOL_PROGRAM_ADDRESS,
    seeds: ["position", getAddressEncoder22().encode(positionMint)]
  });
}

// src/pda/positionBundle.ts
import { getAddressEncoder as getAddressEncoder23, getProgramDerivedAddress as getProgramDerivedAddress4 } from "@solana/kit";
async function getPositionBundleAddress(positionBundleMint) {
  return await getProgramDerivedAddress4({
    programAddress: WHIRLPOOL_PROGRAM_ADDRESS,
    seeds: ["position_bundle", getAddressEncoder23().encode(positionBundleMint)]
  });
}
async function getBundledPositionAddress(positionBundleAddress, bundleIndex) {
  return await getProgramDerivedAddress4({
    ...
    seeds: [
      "bundled_position",
      getAddressEncoder23().encode(positionBundleAddress),
...
import { getAddressEncoder as getAddressEncoder24, getProgramDerivedAddress as getProgramDerivedAddress5 } from "@solana/kit";
async function getTickArrayAddress(whirlpool, startTickIndex) {
  return await getProgramDerivedAddress5({
    programAddress: WHIRLPOOL_PROGRAM_ADDRESS,
    seeds: [
      "tick_array",
      getAddressEncoder24().encode(whirlpool),
      `${startTickIndex}`
    ]
  });
}
...
import { getAddressEncoder as getAddressEncoder25, getProgramDerivedAddress as getProgramDerivedAddress6 } from "@solana/kit";
async function getTokenBadgeAddress(whirlpoolsConfig, tokenMint) {
  return await getProgramDerivedAddress6({
    ...
    seeds: [
      ...
      getAddressEncoder25().encode(tokenMint)
    ]
  });
}
...
async function getWhirlpoolAddress(whirlpoolsConfig, tokenMintA, tokenMintB, tickSpacing) {
  return await getProgramDerivedAddress7({
    ...
    seeds: [
      "whirlpool",
      getAddressEncoder26().encode(whirlpoolsConfig),
      getAddressEncoder26().encode(tokenMintA),
      getAddressEncoder26().encode(tokenMintB),
...
import { getAddressEncoder as getAddressEncoder27, getProgramDerivedAddress as getProgramDerivedAddress8 } from "@solana/kit";
async function getWhirlpoolsConfigExtensionAddress(configAddress) {
  return await getProgramDerivedAddress8({
    programAddress: WHIRLPOOL_PROGRAM_ADDRESS,
    seeds: ["config_extension", getAddressEncoder27().encode(configAddress)]
  });
}
export {
  AccountsType,
