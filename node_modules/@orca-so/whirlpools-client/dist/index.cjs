...
function getFeeTierDiscriminatorBytes() {
  return (0, import_kit.fixEncoderSize)((0, import_kit.getBytesEncoder)(), 8).encode(FEE_TIER_DISCRIMINATOR);
}
function getFeeTierEncoder() {
  return (0, import_kit.transformEncoder)(
    (0, import_kit.getStructEncoder)([
      ...
      ["defaultFeeRate", (0, import_kit.getU16Encoder)()]
    ]),
...
function getFeeTierDecoder() {
  return (0, import_kit.getStructDecoder)([
    ...
    ["defaultFeeRate", (0, import_kit.getU16Decoder)()]
  ]);
}
function getFeeTierCodec() {
  return (0, import_kit.combineCodec)(getFeeTierEncoder(), getFeeTierDecoder());
}
...
function getAccountsTypeEncoder() {
  return (0, import_kit2.getEnumEncoder)(AccountsType);
}
function getAccountsTypeDecoder() {
  return (0, import_kit2.getEnumDecoder)(AccountsType);
}
function getAccountsTypeCodec() {
  return (0, import_kit2.combineCodec)(getAccountsTypeEncoder(), getAccountsTypeDecoder());
}
...
function getLockTypeEncoder() {
  return (0, import_kit3.getEnumEncoder)(LockType);
}
function getLockTypeDecoder() {
  return (0, import_kit3.getEnumDecoder)(LockType);
}
function getLockTypeCodec() {
  return (0, import_kit3.combineCodec)(getLockTypeEncoder(), getLockTypeDecoder());
}
...
function getLockTypeLabelEncoder() {
  return (0, import_kit4.getEnumEncoder)(LockTypeLabel);
}
function getLockTypeLabelDecoder() {
  return (0, import_kit4.getEnumDecoder)(LockTypeLabel);
}
function getLockTypeLabelCodec() {
  return (0, import_kit4.combineCodec)(getLockTypeLabelEncoder(), getLockTypeLabelDecoder());
}
...
function getPositionRewardInfoEncoder() {
  return (0, import_kit5.getStructEncoder)([
    ["growthInsideCheckpoint", (0, import_kit5.getU128Encoder)()],
    ["amountOwed", (0, import_kit5.getU64Encoder)()]
  ]);
}
function getPositionRewardInfoDecoder() {
  return (0, import_kit5.getStructDecoder)([
    ["growthInsideCheckpoint", (0, import_kit5.getU128Decoder)()],
    ["amountOwed", (0, import_kit5.getU64Decoder)()]
  ]);
}
...
function getRemainingAccountsInfoEncoder() {
  return (0, import_kit6.getStructEncoder)([
    ["slices", (0, import_kit6.getArrayEncoder)(getRemainingAccountsSliceEncoder())]
  ]);
}
function getRemainingAccountsInfoDecoder() {
  return (0, import_kit6.getStructDecoder)([
    ["slices", (0, import_kit6.getArrayDecoder)(getRemainingAccountsSliceDecoder())]
  ]);
}
...
function getTickEncoder() {
  return (0, import_kit8.getStructEncoder)([
    ["initialized", (0, import_kit8.getBooleanEncoder)()],
    ["liquidityNet", (0, import_kit8.getI128Encoder)()],
    ["liquidityGross", (0, import_kit8.getU128Encoder)()],
    ["feeGrowthOutsideA", (0, import_kit8.getU128Encoder)()],
    ["feeGrowthOutsideB", (0, import_kit8.getU128Encoder)()],
    ["rewardGrowthsOutside", (0, import_kit8.getArrayEncoder)((0, import_kit8.getU128Encoder)(), { size: 3 })]
  ]);
}
function getTickDecoder() {
  return (0, import_kit8.getStructDecoder)([
    ["initialized", (0, import_kit8.getBooleanDecoder)()],
    ["liquidityNet", (0, import_kit8.getI128Decoder)()],
    ["liquidityGross", (0, import_kit8.getU128Decoder)()],
    ["feeGrowthOutsideA", (0, import_kit8.getU128Decoder)()],
    ["feeGrowthOutsideB", (0, import_kit8.getU128Decoder)()],
    ["rewardGrowthsOutside", (0, import_kit8.getArrayDecoder)((0, import_kit8.getU128Decoder)(), { size: 3 })]
  ]);
}
function getTickCodec() {
  return (0, import_kit8.combineCodec)(getTickEncoder(), getTickDecoder());
}
...
function getWhirlpoolRewardInfoEncoder() {
  return (0, import_kit9.getStructEncoder)([
    ["mint", (0, import_kit9.getAddressEncoder)()],
    ["vault", (0, import_kit9.getAddressEncoder)()],
    ["authority", (0, import_kit9.getAddressEncoder)()],
    ["emissionsPerSecondX64", (0, import_kit9.getU128Encoder)()],
    ["growthGlobalX64", (0, import_kit9.getU128Encoder)()]
  ]);
}
function getWhirlpoolRewardInfoDecoder() {
  return (0, import_kit9.getStructDecoder)([
    ["mint", (0, import_kit9.getAddressDecoder)()],
    ["vault", (0, import_kit9.getAddressDecoder)()],
    ["authority", (0, import_kit9.getAddressDecoder)()],
    ["emissionsPerSecondX64", (0, import_kit9.getU128Decoder)()],
    ["growthGlobalX64", (0, import_kit9.getU128Decoder)()]
  ]);
}
...
function getLockConfigDiscriminatorBytes() {
  return (0, import_kit10.fixEncoderSize)((0, import_kit10.getBytesEncoder)(), 8).encode(LOCK_CONFIG_DISCRIMINATOR);
}
function getLockConfigEncoder() {
  return (0, import_kit10.transformEncoder)(
    (0, import_kit10.getStructEncoder)([
      ...
      ["position", (0, import_kit10.getAddressEncoder)()],
      ["positionOwner", (0, import_kit10.getAddressEncoder)()],
      ["whirlpool", (0, import_kit10.getAddressEncoder)()],
      ["lockedTimestamp", (0, import_kit10.getU64Encoder)()],
...
function getLockConfigDecoder() {
  return (0, import_kit10.getStructDecoder)([
    ...
    ["position", (0, import_kit10.getAddressDecoder)()],
    ["positionOwner", (0, import_kit10.getAddressDecoder)()],
    ["whirlpool", (0, import_kit10.getAddressDecoder)()],
    ["lockedTimestamp", (0, import_kit10.getU64Decoder)()],
    ["lockType", getLockTypeLabelDecoder()]
  ]);
}
function getLockConfigCodec() {
  return (0, import_kit10.combineCodec)(getLockConfigEncoder(), getLockConfigDecoder());
}
function decodeLockConfig(encodedAccount) {
  return (0, import_kit10.decodeAccount)(
    encodedAccount,
...
async function fetchMaybeLockConfig(rpc, address, config) {
  const maybeAccount = await (0, import_kit10.fetchEncodedAccount)(rpc, address, config);
...
async function fetchAllLockConfig(rpc, addresses, config) {
  ...
  (0, import_kit10.assertAccountsExist)(maybeAccounts);
  return maybeAccounts;
}
async function fetchAllMaybeLockConfig(rpc, addresses, config) {
  const maybeAccounts = await (0, import_kit10.fetchEncodedAccounts)(rpc, addresses, config);
...
function getPositionDiscriminatorBytes() {
  return (0, import_kit11.fixEncoderSize)((0, import_kit11.getBytesEncoder)(), 8).encode(POSITION_DISCRIMINATOR);
}
function getPositionEncoder() {
  return (0, import_kit11.transformEncoder)(
    (0, import_kit11.getStructEncoder)([
      ...
      ["whirlpool", (0, import_kit11.getAddressEncoder)()],
      ["positionMint", (0, import_kit11.getAddressEncoder)()],
      ["liquidity", (0, import_kit11.getU128Encoder)()],
      ["tickLowerIndex", (0, import_kit11.getI32Encoder)()],
      ["tickUpperIndex", (0, import_kit11.getI32Encoder)()],
      ["feeGrowthCheckpointA", (0, import_kit11.getU128Encoder)()],
      ["feeOwedA", (0, import_kit11.getU64Encoder)()],
      ["feeGrowthCheckpointB", (0, import_kit11.getU128Encoder)()],
      ["feeOwedB", (0, import_kit11.getU64Encoder)()],
      [
        "rewardInfos",
        (0, import_kit11.getArrayEncoder)(getPositionRewardInfoEncoder(), { size: 3 })
      ]
    ]),
...
function getPositionDecoder() {
  return (0, import_kit11.getStructDecoder)([
    ...
    ["whirlpool", (0, import_kit11.getAddressDecoder)()],
    ["positionMint", (0, import_kit11.getAddressDecoder)()],
    ["liquidity", (0, import_kit11.getU128Decoder)()],
    ["tickLowerIndex", (0, import_kit11.getI32Decoder)()],
    ["tickUpperIndex", (0, import_kit11.getI32Decoder)()],
    ["feeGrowthCheckpointA", (0, import_kit11.getU128Decoder)()],
    ["feeOwedA", (0, import_kit11.getU64Decoder)()],
    ["feeGrowthCheckpointB", (0, import_kit11.getU128Decoder)()],
    ["feeOwedB", (0, import_kit11.getU64Decoder)()],
    [
      "rewardInfos",
      (0, import_kit11.getArrayDecoder)(getPositionRewardInfoDecoder(), { size: 3 })
    ]
  ]);
}
function getPositionCodec() {
  return (0, import_kit11.combineCodec)(getPositionEncoder(), getPositionDecoder());
}
function decodePosition(encodedAccount) {
  return (0, import_kit11.decodeAccount)(
    encodedAccount,
    getPositionDecoder()
  );
}
...
async function fetchMaybePosition(rpc, address, config) {
  const maybeAccount = await (0, import_kit11.fetchEncodedAccount)(rpc, address, config);
...
async function fetchAllPosition(rpc, addresses, config) {
  ...
  (0, import_kit11.assertAccountsExist)(maybeAccounts);
  return maybeAccounts;
}
async function fetchAllMaybePosition(rpc, addresses, config) {
  const maybeAccounts = await (0, import_kit11.fetchEncodedAccounts)(rpc, addresses, config);
...
function getPositionBundleEncoder() {
  return (0, import_kit12.transformEncoder)(
    (0, import_kit12.getStructEncoder)([
      ...
      ["positionBundleMint", (0, import_kit12.getAddressEncoder)()],
      ["positionBitmap", (0, import_kit12.fixEncoderSize)((0, import_kit12.getBytesEncoder)(), 32)]
    ]),
...
function getPositionBundleDecoder() {
  return (0, import_kit12.getStructDecoder)([
    ...
    ["positionBundleMint", (0, import_kit12.getAddressDecoder)()],
    ["positionBitmap", (0, import_kit12.fixDecoderSize)((0, import_kit12.getBytesDecoder)(), 32)]
  ]);
}
function getPositionBundleCodec() {
  return (0, import_kit12.combineCodec)(getPositionBundleEncoder(), getPositionBundleDecoder());
}
function decodePositionBundle(encodedAccount) {
  return (0, import_kit12.decodeAccount)(
    encodedAccount,
...
async function fetchMaybePositionBundle(rpc, address, config) {
  const maybeAccount = await (0, import_kit12.fetchEncodedAccount)(rpc, address, config);
...
async function fetchAllPositionBundle(rpc, addresses, config) {
  ...
  (0, import_kit12.assertAccountsExist)(maybeAccounts);
  return maybeAccounts;
}
async function fetchAllMaybePositionBundle(rpc, addresses, config) {
  const maybeAccounts = await (0, import_kit12.fetchEncodedAccounts)(rpc, addresses, config);
...
function getTickArrayDiscriminatorBytes() {
  return (0, import_kit13.fixEncoderSize)((0, import_kit13.getBytesEncoder)(), 8).encode(TICK_ARRAY_DISCRIMINATOR);
}
function getTickArrayEncoder() {
  return (0, import_kit13.transformEncoder)(
    (0, import_kit13.getStructEncoder)([
      ...
      ["startTickIndex", (0, import_kit13.getI32Encoder)()],
      ["ticks", (0, import_kit13.getArrayEncoder)(getTickEncoder(), { size: 88 })],
...
function getTickArrayDecoder() {
  return (0, import_kit13.getStructDecoder)([
    ...
    ["startTickIndex", (0, import_kit13.getI32Decoder)()],
    ["ticks", (0, import_kit13.getArrayDecoder)(getTickDecoder(), { size: 88 })],
    ["whirlpool", (0, import_kit13.getAddressDecoder)()]
  ]);
}
function getTickArrayCodec() {
  return (0, import_kit13.combineCodec)(getTickArrayEncoder(), getTickArrayDecoder());
}
...
function getTokenBadgeDiscriminatorBytes() {
  return (0, import_kit14.fixEncoderSize)((0, import_kit14.getBytesEncoder)(), 8).encode(TOKEN_BADGE_DISCRIMINATOR);
}
function getTokenBadgeEncoder() {
  return (0, import_kit14.transformEncoder)(
    (0, import_kit14.getStructEncoder)([
      ...
      ["whirlpoolsConfig", (0, import_kit14.getAddressEncoder)()],
...
function getTokenBadgeDecoder() {
  return (0, import_kit14.getStructDecoder)([
    ...
    ["whirlpoolsConfig", (0, import_kit14.getAddressDecoder)()],
    ["tokenMint", (0, import_kit14.getAddressDecoder)()]
  ]);
}
function getTokenBadgeCodec() {
  return (0, import_kit14.combineCodec)(getTokenBadgeEncoder(), getTokenBadgeDecoder());
}
...
function getWhirlpoolDiscriminatorBytes() {
  return (0, import_kit15.fixEncoderSize)((0, import_kit15.getBytesEncoder)(), 8).encode(WHIRLPOOL_DISCRIMINATOR);
}
function getWhirlpoolEncoder() {
  return (0, import_kit15.transformEncoder)(
    (0, import_kit15.getStructEncoder)([
      ...
      ["whirlpoolsConfig", (0, import_kit15.getAddressEncoder)()],
      ["whirlpoolBump", (0, import_kit15.fixEncoderSize)((0, import_kit15.getBytesEncoder)(), 1)],
      ["tickSpacing", (0, import_kit15.getU16Encoder)()],
      ["tickSpacingSeed", (0, import_kit15.fixEncoderSize)((0, import_kit15.getBytesEncoder)(), 2)],
      ["feeRate", (0, import_kit15.getU16Encoder)()],
      ["protocolFeeRate", (0, import_kit15.getU16Encoder)()],
      ["liquidity", (0, import_kit15.getU128Encoder)()],
      ["sqrtPrice", (0, import_kit15.getU128Encoder)()],
      ["tickCurrentIndex", (0, import_kit15.getI32Encoder)()],
      ["protocolFeeOwedA", (0, import_kit15.getU64Encoder)()],
      ["protocolFeeOwedB", (0, import_kit15.getU64Encoder)()],
      ["tokenMintA", (0, import_kit15.getAddressEncoder)()],
      ["tokenVaultA", (0, import_kit15.getAddressEncoder)()],
      ["feeGrowthGlobalA", (0, import_kit15.getU128Encoder)()],
      ["tokenMintB", (0, import_kit15.getAddressEncoder)()],
      ["tokenVaultB", (0, import_kit15.getAddressEncoder)()],
      ["feeGrowthGlobalB", (0, import_kit15.getU128Encoder)()],
      ["rewardLastUpdatedTimestamp", (0, import_kit15.getU64Encoder)()],
      [
        "rewardInfos",
        (0, import_kit15.getArrayEncoder)(getWhirlpoolRewardInfoEncoder(), { size: 3 })
      ]
    ]),
...
function getWhirlpoolDecoder() {
  return (0, import_kit15.getStructDecoder)([
    ...
    ["whirlpoolsConfig", (0, import_kit15.getAddressDecoder)()],
    ["whirlpoolBump", (0, import_kit15.fixDecoderSize)((0, import_kit15.getBytesDecoder)(), 1)],
    ["tickSpacing", (0, import_kit15.getU16Decoder)()],
    ["tickSpacingSeed", (0, import_kit15.fixDecoderSize)((0, import_kit15.getBytesDecoder)(), 2)],
    ["feeRate", (0, import_kit15.getU16Decoder)()],
    ["protocolFeeRate", (0, import_kit15.getU16Decoder)()],
    ["liquidity", (0, import_kit15.getU128Decoder)()],
    ["sqrtPrice", (0, import_kit15.getU128Decoder)()],
    ["tickCurrentIndex", (0, import_kit15.getI32Decoder)()],
    ["protocolFeeOwedA", (0, import_kit15.getU64Decoder)()],
    ["protocolFeeOwedB", (0, import_kit15.getU64Decoder)()],
    ["tokenMintA", (0, import_kit15.getAddressDecoder)()],
    ["tokenVaultA", (0, import_kit15.getAddressDecoder)()],
    ["feeGrowthGlobalA", (0, import_kit15.getU128Decoder)()],
    ["tokenMintB", (0, import_kit15.getAddressDecoder)()],
    ["tokenVaultB", (0, import_kit15.getAddressDecoder)()],
    ["feeGrowthGlobalB", (0, import_kit15.getU128Decoder)()],
    ["rewardLastUpdatedTimestamp", (0, import_kit15.getU64Decoder)()],
    [
      "rewardInfos",
      (0, import_kit15.getArrayDecoder)(getWhirlpoolRewardInfoDecoder(), { size: 3 })
    ]
  ]);
}
function getWhirlpoolCodec() {
  return (0, import_kit15.combineCodec)(getWhirlpoolEncoder(), getWhirlpoolDecoder());
}
...
function getWhirlpoolsConfigEncoder() {
  return (0, import_kit16.transformEncoder)(
    (0, import_kit16.getStructEncoder)([
      ...
      ["feeAuthority", (0, import_kit16.getAddressEncoder)()],
      ["collectProtocolFeesAuthority", (0, import_kit16.getAddressEncoder)()],
      ["rewardEmissionsSuperAuthority", (0, import_kit16.getAddressEncoder)()],
      ["defaultProtocolFeeRate", (0, import_kit16.getU16Encoder)()]
    ]),
...
function getWhirlpoolsConfigDecoder() {
  return (0, import_kit16.getStructDecoder)([
    ...
    ["feeAuthority", (0, import_kit16.getAddressDecoder)()],
    ["collectProtocolFeesAuthority", (0, import_kit16.getAddressDecoder)()],
    ["rewardEmissionsSuperAuthority", (0, import_kit16.getAddressDecoder)()],
    ["defaultProtocolFeeRate", (0, import_kit16.getU16Decoder)()]
  ]);
}
...
function getWhirlpoolsConfigExtensionEncoder() {
  return (0, import_kit17.transformEncoder)(
    (0, import_kit17.getStructEncoder)([
      ...
      ["whirlpoolsConfig", (0, import_kit17.getAddressEncoder)()],
      ["configExtensionAuthority", (0, import_kit17.getAddressEncoder)()],
      ["tokenBadgeAuthority", (0, import_kit17.getAddressEncoder)()]
    ]),
    (value) => ({
      ...value,
...
function getWhirlpoolsConfigExtensionDecoder() {
  return (0, import_kit17.getStructDecoder)([
    ...
    ["whirlpoolsConfig", (0, import_kit17.getAddressDecoder)()],
    ["configExtensionAuthority", (0, import_kit17.getAddressDecoder)()],
    ["tokenBadgeAuthority", (0, import_kit17.getAddressDecoder)()]
  ]);
}
...
var WhirlpoolAccount = /* @__PURE__ */ ((WhirlpoolAccount2) => {
  ...
  WhirlpoolAccount2[WhirlpoolAccount2["LockConfig"] = 3] = "LockConfig";
  WhirlpoolAccount2[WhirlpoolAccount2["Position"] = 4] = "Position";
  WhirlpoolAccount2[WhirlpoolAccount2["PositionBundle"] = 5] = "PositionBundle";
  WhirlpoolAccount2[WhirlpoolAccount2["TickArray"] = 6] = "TickArray";
  WhirlpoolAccount2[WhirlpoolAccount2["TokenBadge"] = 7] = "TokenBadge";
  WhirlpoolAccount2[WhirlpoolAccount2["Whirlpool"] = 8] = "Whirlpool";
  return WhirlpoolAccount2;
})(WhirlpoolAccount || {});
function identifyWhirlpoolAccount(account) {
  const data = "data" in account ? account.data : account;
  if ((0, import_kit18.containsBytes)(
    data,
    (0, import_kit18.fixEncoderSize)((0, import_kit18.getBytesEncoder)(), 8).encode(
...
var WhirlpoolInstruction = /* @__PURE__ */ ((WhirlpoolInstruction2) => {
  ...
  WhirlpoolInstruction2[WhirlpoolInstruction2["CollectFeesV2"] = 34] = "CollectFeesV2";
  WhirlpoolInstruction2[WhirlpoolInstruction2["CollectProtocolFeesV2"] = 35] = "CollectProtocolFeesV2";
  WhirlpoolInstruction2[WhirlpoolInstruction2["CollectRewardV2"] = 36] = "CollectRewardV2";
  WhirlpoolInstruction2[WhirlpoolInstruction2["DecreaseLiquidityV2"] = 37] = "DecreaseLiquidityV2";
  WhirlpoolInstruction2[WhirlpoolInstruction2["IncreaseLiquidityV2"] = 38] = "IncreaseLiquidityV2";
  WhirlpoolInstruction2[WhirlpoolInstruction2["InitializePoolV2"] = 39] = "InitializePoolV2";
  WhirlpoolInstruction2[WhirlpoolInstruction2["InitializeRewardV2"] = 40] = "InitializeRewardV2";
  WhirlpoolInstruction2[WhirlpoolInstruction2["SetRewardEmissionsV2"] = 41] = "SetRewardEmissionsV2";
  WhirlpoolInstruction2[WhirlpoolInstruction2["SwapV2"] = 42] = "SwapV2";
  WhirlpoolInstruction2[WhirlpoolInstruction2["TwoHopSwapV2"] = 43] = "TwoHopSwapV2";
  WhirlpoolInstruction2[WhirlpoolInstruction2["InitializeConfigExtension"] = 44] = "InitializeConfigExtension";
  WhirlpoolInstruction2[WhirlpoolInstruction2["SetConfigExtensionAuthority"] = 45] = "SetConfigExtensionAuthority";
  WhirlpoolInstruction2[WhirlpoolInstruction2["SetTokenBadgeAuthority"] = 46] = "SetTokenBadgeAuthority";
  WhirlpoolInstruction2[WhirlpoolInstruction2["InitializeTokenBadge"] = 47] = "InitializeTokenBadge";
  WhirlpoolInstruction2[WhirlpoolInstruction2["DeleteTokenBadge"] = 48] = "DeleteTokenBadge";
...
function identifyWhirlpoolInstruction(instruction) {
  ...
  if ((0, import_kit18.containsBytes)(
    ...
    return 35 /* CollectProtocolFeesV2 */;
  }
  if ((0, import_kit18.containsBytes)(
    data,
    (0, import_kit18.fixEncoderSize)((0, import_kit18.getBytesEncoder)(), 8).encode(
  ...
  if ((0, import_kit18.containsBytes)(
    ...
    return 41 /* SetRewardEmissionsV2 */;
  }
  if ((0, import_kit18.containsBytes)(
    data,
    (0, import_kit18.fixEncoderSize)((0, import_kit18.getBytesEncoder)(), 8).encode(
  ...
  if ((0, import_kit18.containsBytes)(
    ...
    return 44 /* InitializeConfigExtension */;
  }
  if ((0, import_kit18.containsBytes)(
    data,
    (0, import_kit18.fixEncoderSize)((0, import_kit18.getBytesEncoder)(), 8).encode(
    ...
    return 45 /* SetConfigExtensionAuthority */;
  }
  if ((0, import_kit18.containsBytes)(
    data,
    (0, import_kit18.fixEncoderSize)((0, import_kit18.getBytesEncoder)(), 8).encode(
    ...
    return 46 /* SetTokenBadgeAuthority */;
  }
  if ((0, import_kit18.containsBytes)(
    data,
    (0, import_kit18.fixEncoderSize)((0, import_kit18.getBytesEncoder)(), 8).encode(
    ...
    return 47 /* InitializeTokenBadge */;
  }
  if ((0, import_kit18.containsBytes)(
    data,
    (0, import_kit18.fixEncoderSize)((0, import_kit18.getBytesEncoder)(), 8).encode(
...
function isWhirlpoolError(error, transactionMessage, code) {
  return (0, import_kit19.isProgramError)(
    error,
    transactionMessage,
  ...
  return (account) => {
    if (!account.value) {
      ...
      return Object.freeze({
        ...
        role: import_kit20.AccountRole.READONLY
      });
    }
    const writableRole = account.isWritable ? import_kit20.AccountRole.WRITABLE : import_kit20.AccountRole.READONLY;
    return Object.freeze({
      address: expectAddress(account.value),
      role: isTransactionSigner(account.value) ? (0, import_kit20.upgradeRoleToSigner)(writableRole) : writableRole,
      ...isTransactionSigner(account.value) ? { signer: account.value } : {}
    });
  };
}
function isTransactionSigner(value) {
  return !!value && typeof value === "object" && "address" in value && (0, import_kit20.isTransactionSigner)(value);
}
...
function getCloseBundledPositionInstructionDataEncoder() {
  return (0, import_kit21.transformEncoder)(
    (0, import_kit21.getStructEncoder)([
      ...
      ["bundleIndex", (0, import_kit21.getU16Encoder)()]
    ]),
    (value) => ({
      ...value,
...
function getCloseBundledPositionInstructionDataDecoder() {
  return (0, import_kit21.getStructDecoder)([
    ...
    ["bundleIndex", (0, import_kit21.getU16Decoder)()]
  ]);
}
...
function getClosePositionInstructionDataEncoder() {
  return (0, import_kit22.transformEncoder)(
    (0, import_kit22.getStructEncoder)([["discriminator", (0, import_kit22.fixEncoderSize)((0, import_kit22.getBytesEncoder)(), 8)]]),
...
function getClosePositionWithTokenExtensionsInstructionDataEncoder() {
  return (0, import_kit23.transformEncoder)(
    (0, import_kit23.getStructEncoder)([["discriminator", (0, import_kit23.fixEncoderSize)((0, import_kit23.getBytesEncoder)(), 8)]]),
    (value) => ({
      ...value,
...
function getCollectFeesInstructionDataEncoder() {
  return (0, import_kit24.transformEncoder)(
    (0, import_kit24.getStructEncoder)([["discriminator", (0, import_kit24.fixEncoderSize)((0, import_kit24.getBytesEncoder)(), 8)]]),
  ...
  return (0, import_kit25.transformEncoder)(
    (0, import_kit25.getStructEncoder)([
      ...
      [
        ...
        (0, import_kit25.getOptionEncoder)(getRemainingAccountsInfoEncoder())
      ]
    ]),
...
function getCollectFeesV2InstructionDataDecoder() {
  return (0, import_kit25.getStructDecoder)([
    ...
    [
      "remainingAccountsInfo",
      (0, import_kit25.getOptionDecoder)(getRemainingAccountsInfoDecoder())
    ]
  ]);
}
...
function getCollectProtocolFeesV2InstructionDataEncoder() {
  return (0, import_kit27.transformEncoder)(
    (0, import_kit27.getStructEncoder)([
      ...
      [
        "remainingAccountsInfo",
        (0, import_kit27.getOptionEncoder)(getRemainingAccountsInfoEncoder())
      ]
    ]),
    (value) => ({
      ...value,
...
function getCollectProtocolFeesV2InstructionDataDecoder() {
  return (0, import_kit27.getStructDecoder)([
    ...
    [
      "remainingAccountsInfo",
      (0, import_kit27.getOptionDecoder)(getRemainingAccountsInfoDecoder())
    ]
  ]);
}
...
function getCollectRewardInstructionDataEncoder() {
  return (0, import_kit28.transformEncoder)(
    (0, import_kit28.getStructEncoder)([
      ["discriminator", (0, import_kit28.fixEncoderSize)((0, import_kit28.getBytesEncoder)(), 8)],
      ["rewardIndex", (0, import_kit28.getU8Encoder)()]
    ]),
...
function getCollectRewardInstructionDataDecoder() {
  return (0, import_kit28.getStructDecoder)([
    ...
    ["rewardIndex", (0, import_kit28.getU8Decoder)()]
  ]);
}
...
function getCollectRewardV2InstructionDataEncoder() {
  return (0, import_kit29.transformEncoder)(
    (0, import_kit29.getStructEncoder)([
      ...
      ["rewardIndex", (0, import_kit29.getU8Encoder)()],
      [
        "remainingAccountsInfo",
...
function getCollectRewardV2InstructionDataDecoder() {
  return (0, import_kit29.getStructDecoder)([
    ...
    ["rewardIndex", (0, import_kit29.getU8Decoder)()],
    [
      "remainingAccountsInfo",
...
function getDecreaseLiquidityInstructionDataEncoder() {
  return (0, import_kit30.transformEncoder)(
    (0, import_kit30.getStructEncoder)([
      ...
      ["liquidityAmount", (0, import_kit30.getU128Encoder)()],
      ["tokenMinA", (0, import_kit30.getU64Encoder)()],
      ["tokenMinB", (0, import_kit30.getU64Encoder)()]
    ]),
...
function getDecreaseLiquidityInstructionDataDecoder() {
  return (0, import_kit30.getStructDecoder)([
    ...
    ["liquidityAmount", (0, import_kit30.getU128Decoder)()],
    ["tokenMinA", (0, import_kit30.getU64Decoder)()],
    ["tokenMinB", (0, import_kit30.getU64Decoder)()]
  ]);
}
...
function getDecreaseLiquidityV2InstructionDataEncoder() {
  return (0, import_kit31.transformEncoder)(
    (0, import_kit31.getStructEncoder)([
      ...
      ["liquidityAmount", (0, import_kit31.getU128Encoder)()],
      ["tokenMinA", (0, import_kit31.getU64Encoder)()],
      ["tokenMinB", (0, import_kit31.getU64Encoder)()],
      [
        "remainingAccountsInfo",
...
function getDecreaseLiquidityV2InstructionDataDecoder() {
  return (0, import_kit31.getStructDecoder)([
    ...
    ["liquidityAmount", (0, import_kit31.getU128Decoder)()],
    ["tokenMinA", (0, import_kit31.getU64Decoder)()],
    ["tokenMinB", (0, import_kit31.getU64Decoder)()],
    [
      "remainingAccountsInfo",
...
function getDeleteTokenBadgeInstructionDataEncoder() {
  return (0, import_kit33.transformEncoder)(
    (0, import_kit33.getStructEncoder)([["discriminator", (0, import_kit33.fixEncoderSize)((0, import_kit33.getBytesEncoder)(), 8)]]),
...
function getIncreaseLiquidityInstructionDataEncoder() {
  return (0, import_kit34.transformEncoder)(
    (0, import_kit34.getStructEncoder)([
      ...
      ["tokenMaxA", (0, import_kit34.getU64Encoder)()],
      ["tokenMaxB", (0, import_kit34.getU64Encoder)()]
    ]),
...
function getIncreaseLiquidityInstructionDataDecoder() {
  return (0, import_kit34.getStructDecoder)([
    ...
    ["tokenMaxA", (0, import_kit34.getU64Decoder)()],
    ["tokenMaxB", (0, import_kit34.getU64Decoder)()]
  ]);
}
...
function getIncreaseLiquidityV2InstructionDataEncoder() {
  return (0, import_kit35.transformEncoder)(
    (0, import_kit35.getStructEncoder)([
      ...
      ["tokenMaxA", (0, import_kit35.getU64Encoder)()],
      ["tokenMaxB", (0, import_kit35.getU64Encoder)()],
      [
        "remainingAccountsInfo",
...
function getIncreaseLiquidityV2InstructionDataDecoder() {
  return (0, import_kit35.getStructDecoder)([
    ...
    ["tokenMaxA", (0, import_kit35.getU64Decoder)()],
    ["tokenMaxB", (0, import_kit35.getU64Decoder)()],
    [
      "remainingAccountsInfo",
...
function getInitializeConfigInstructionDataEncoder() {
  return (0, import_kit36.transformEncoder)(
    (0, import_kit36.getStructEncoder)([
      ...
      ["feeAuthority", (0, import_kit36.getAddressEncoder)()],
      ["collectProtocolFeesAuthority", (0, import_kit36.getAddressEncoder)()],
      ["rewardEmissionsSuperAuthority", (0, import_kit36.getAddressEncoder)()],
      ["defaultProtocolFeeRate", (0, import_kit36.getU16Encoder)()]
    ]),
...
function getInitializeConfigInstructionDataDecoder() {
  return (0, import_kit36.getStructDecoder)([
    ...
    ["feeAuthority", (0, import_kit36.getAddressDecoder)()],
    ["collectProtocolFeesAuthority", (0, import_kit36.getAddressDecoder)()],
    ["rewardEmissionsSuperAuthority", (0, import_kit36.getAddressDecoder)()],
    ["defaultProtocolFeeRate", (0, import_kit36.getU16Decoder)()]
  ]);
}
...
function getInitializeFeeTierInstructionDataEncoder() {
  return (0, import_kit38.transformEncoder)(
    (0, import_kit38.getStructEncoder)([
      ...
      ["tickSpacing", (0, import_kit38.getU16Encoder)()],
      ["defaultFeeRate", (0, import_kit38.getU16Encoder)()]
    ]),
...
function getInitializeFeeTierInstructionDataDecoder() {
  return (0, import_kit38.getStructDecoder)([
    ...
    ["tickSpacing", (0, import_kit38.getU16Decoder)()],
    ["defaultFeeRate", (0, import_kit38.getU16Decoder)()]
  ]);
}
...
function getInitializePoolInstructionDataEncoder() {
  return (0, import_kit39.transformEncoder)(
    (0, import_kit39.getStructEncoder)([
      ...
      ["whirlpoolBump", (0, import_kit39.getU8Encoder)()],
      ["tickSpacing", (0, import_kit39.getU16Encoder)()],
      ["initialSqrtPrice", (0, import_kit39.getU128Encoder)()]
    ]),
...
function getInitializePoolInstructionDataDecoder() {
  return (0, import_kit39.getStructDecoder)([
    ...
    ["whirlpoolBump", (0, import_kit39.getU8Decoder)()],
    ["tickSpacing", (0, import_kit39.getU16Decoder)()],
    ["initialSqrtPrice", (0, import_kit39.getU128Decoder)()]
  ]);
}
...
function getInitializePoolV2InstructionDataEncoder() {
  return (0, import_kit40.transformEncoder)(
    (0, import_kit40.getStructEncoder)([
      ...
      ["initialSqrtPrice", (0, import_kit40.getU128Encoder)()]
    ]),
...
function getInitializePoolV2InstructionDataDecoder() {
  return (0, import_kit40.getStructDecoder)([
    ...
    ["initialSqrtPrice", (0, import_kit40.getU128Decoder)()]
  ]);
}
...
function getInitializePositionBundleInstructionDataEncoder() {
  return (0, import_kit41.transformEncoder)(
    (0, import_kit41.getStructEncoder)([["discriminator", (0, import_kit41.fixEncoderSize)((0, import_kit41.getBytesEncoder)(), 8)]]),
    (value) => ({
      ...value,
...
function getInitializeRewardInstructionDataEncoder() {
  return (0, import_kit43.transformEncoder)(
    (0, import_kit43.getStructEncoder)([
      ...
      ["rewardIndex", (0, import_kit43.getU8Encoder)()]
    ]),
...
function getInitializeRewardInstructionDataDecoder() {
  return (0, import_kit43.getStructDecoder)([
    ...
    ["rewardIndex", (0, import_kit43.getU8Decoder)()]
  ]);
}
...
function getInitializeRewardV2InstructionDataEncoder() {
  return (0, import_kit44.transformEncoder)(
    (0, import_kit44.getStructEncoder)([
      ...
      ["rewardIndex", (0, import_kit44.getU8Encoder)()]
    ]),
...
function getInitializeRewardV2InstructionDataDecoder() {
  return (0, import_kit44.getStructDecoder)([
    ...
    ["rewardIndex", (0, import_kit44.getU8Decoder)()]
  ]);
}
...
function getInitializeTickArrayInstructionDataEncoder() {
  return (0, import_kit45.transformEncoder)(
    (0, import_kit45.getStructEncoder)([
      ...
      ["startTickIndex", (0, import_kit45.getI32Encoder)()]
    ]),
    (value) => ({
      ...value,
...
function getInitializeTickArrayInstructionDataDecoder() {
  return (0, import_kit45.getStructDecoder)([
    ...
    ["startTickIndex", (0, import_kit45.getI32Decoder)()]
  ]);
}
...
function getInitializeTokenBadgeInstructionDataEncoder() {
  return (0, import_kit46.transformEncoder)(
    (0, import_kit46.getStructEncoder)([["discriminator", (0, import_kit46.fixEncoderSize)((0, import_kit46.getBytesEncoder)(), 8)]]),
    (value) => ({
      ...value,
...
function getOpenBundledPositionInstructionDataEncoder() {
  return (0, import_kit48.transformEncoder)(
    (0, import_kit48.getStructEncoder)([
      ...
      ["bundleIndex", (0, import_kit48.getU16Encoder)()],
...
function getOpenBundledPositionInstructionDataDecoder() {
  return (0, import_kit48.getStructDecoder)([
    ...
    ["bundleIndex", (0, import_kit48.getU16Decoder)()],
...
function getOpenPositionInstructionDataEncoder() {
  return (0, import_kit49.transformEncoder)(
    (0, import_kit49.getStructEncoder)([
      ...
      ["positionBump", (0, import_kit49.getU8Encoder)()],
      ["tickLowerIndex", (0, import_kit49.getI32Encoder)()],
      ["tickUpperIndex", (0, import_kit49.getI32Encoder)()]
    ]),
...
function getOpenPositionInstructionDataDecoder() {
  return (0, import_kit49.getStructDecoder)([
    ...
    ["positionBump", (0, import_kit49.getU8Decoder)()],
    ["tickLowerIndex", (0, import_kit49.getI32Decoder)()],
    ["tickUpperIndex", (0, import_kit49.getI32Decoder)()]
  ]);
}
...
function getOpenPositionWithMetadataInstructionDataEncoder() {
  return (0, import_kit50.transformEncoder)(
    (0, import_kit50.getStructEncoder)([
      ...
      ["positionBump", (0, import_kit50.getU8Encoder)()],
      ["metadataBump", (0, import_kit50.getU8Encoder)()],
      ["tickLowerIndex", (0, import_kit50.getI32Encoder)()],
      ["tickUpperIndex", (0, import_kit50.getI32Encoder)()]
    ]),
    (value) => ({
      ...value,
...
function getOpenPositionWithMetadataInstructionDataDecoder() {
  return (0, import_kit50.getStructDecoder)([
    ...
    ["positionBump", (0, import_kit50.getU8Decoder)()],
    ["metadataBump", (0, import_kit50.getU8Decoder)()],
    ["tickLowerIndex", (0, import_kit50.getI32Decoder)()],
    ["tickUpperIndex", (0, import_kit50.getI32Decoder)()]
  ]);
}
...
function getOpenPositionWithTokenExtensionsInstructionDataEncoder() {
  return (0, import_kit51.transformEncoder)(
    (0, import_kit51.getStructEncoder)([
      ...
      ["tickLowerIndex", (0, import_kit51.getI32Encoder)()],
      ["tickUpperIndex", (0, import_kit51.getI32Encoder)()],
      ["withTokenMetadataExtension", (0, import_kit51.getBooleanEncoder)()]
    ]),
    (value) => ({
      ...value,
...
function getOpenPositionWithTokenExtensionsInstructionDataDecoder() {
  return (0, import_kit51.getStructDecoder)([
    ...
    ["tickLowerIndex", (0, import_kit51.getI32Decoder)()],
    ["tickUpperIndex", (0, import_kit51.getI32Decoder)()],
    ["withTokenMetadataExtension", (0, import_kit51.getBooleanDecoder)()]
  ]);
}
...
function getSetDefaultFeeRateInstructionDataEncoder() {
  return (0, import_kit54.transformEncoder)(
    (0, import_kit54.getStructEncoder)([
      ...
      ["defaultFeeRate", (0, import_kit54.getU16Encoder)()]
    ]),
...
function getSetDefaultFeeRateInstructionDataDecoder() {
  return (0, import_kit54.getStructDecoder)([
    ...
    ["defaultFeeRate", (0, import_kit54.getU16Decoder)()]
  ]);
}
...
function getSetDefaultProtocolFeeRateInstructionDataEncoder() {
  return (0, import_kit55.transformEncoder)(
    (0, import_kit55.getStructEncoder)([
      ...
      ["defaultProtocolFeeRate", (0, import_kit55.getU16Encoder)()]
    ]),
    (value) => ({
      ...value,
...
function getSetDefaultProtocolFeeRateInstructionDataDecoder() {
  return (0, import_kit55.getStructDecoder)([
    ...
    ["defaultProtocolFeeRate", (0, import_kit55.getU16Decoder)()]
  ]);
}
...
function getSetFeeRateInstructionDataEncoder() {
  return (0, import_kit57.transformEncoder)(
    (0, import_kit57.getStructEncoder)([
      ...
      ["feeRate", (0, import_kit57.getU16Encoder)()]
    ]),
...
function getSetFeeRateInstructionDataDecoder() {
  return (0, import_kit57.getStructDecoder)([
    ...
    ["feeRate", (0, import_kit57.getU16Decoder)()]
  ]);
}
...
function getSetProtocolFeeRateInstructionDataEncoder() {
  return (0, import_kit58.transformEncoder)(
    (0, import_kit58.getStructEncoder)([
      ...
      ["protocolFeeRate", (0, import_kit58.getU16Encoder)()]
    ]),
    (value) => ({
      ...value,
...
function getSetProtocolFeeRateInstructionDataDecoder() {
  return (0, import_kit58.getStructDecoder)([
    ...
    ["protocolFeeRate", (0, import_kit58.getU16Decoder)()]
  ]);
}
...
function getSetRewardAuthorityInstructionDataEncoder() {
  return (0, import_kit59.transformEncoder)(
    (0, import_kit59.getStructEncoder)([
      ...
      ["rewardIndex", (0, import_kit59.getU8Encoder)()]
    ]),
...
function getSetRewardAuthorityInstructionDataDecoder() {
  return (0, import_kit59.getStructDecoder)([
    ...
    ["rewardIndex", (0, import_kit59.getU8Decoder)()]
  ]);
}
...
function getSetRewardAuthorityBySuperAuthorityInstructionDataEncoder() {
  return (0, import_kit60.transformEncoder)(
    (0, import_kit60.getStructEncoder)([
      ...
      ["rewardIndex", (0, import_kit60.getU8Encoder)()]
    ]),
    (value) => ({
      ...value,
...
function getSetRewardAuthorityBySuperAuthorityInstructionDataDecoder() {
  return (0, import_kit60.getStructDecoder)([
    ...
    ["rewardIndex", (0, import_kit60.getU8Decoder)()]
  ]);
}
...
function getSetRewardEmissionsInstructionDataEncoder() {
  return (0, import_kit61.transformEncoder)(
    (0, import_kit61.getStructEncoder)([
      ...
      ["rewardIndex", (0, import_kit61.getU8Encoder)()],
      ["emissionsPerSecondX64", (0, import_kit61.getU128Encoder)()]
    ]),
...
function getSetRewardEmissionsInstructionDataDecoder() {
  return (0, import_kit61.getStructDecoder)([
    ...
    ["rewardIndex", (0, import_kit61.getU8Decoder)()],
    ["emissionsPerSecondX64", (0, import_kit61.getU128Decoder)()]
  ]);
}
...
function getSetRewardEmissionsV2InstructionDataEncoder() {
  return (0, import_kit63.transformEncoder)(
    (0, import_kit63.getStructEncoder)([
      ...
      ["rewardIndex", (0, import_kit63.getU8Encoder)()],
      ["emissionsPerSecondX64", (0, import_kit63.getU128Encoder)()]
    ]),
    (value) => ({
      ...value,
...
function getSetRewardEmissionsV2InstructionDataDecoder() {
  return (0, import_kit63.getStructDecoder)([
    ...
    ["rewardIndex", (0, import_kit63.getU8Decoder)()],
    ["emissionsPerSecondX64", (0, import_kit63.getU128Decoder)()]
  ]);
}
...
function getSwapDiscriminatorBytes() {
  return (0, import_kit65.fixEncoderSize)((0, import_kit65.getBytesEncoder)(), 8).encode(SWAP_DISCRIMINATOR);
}
function getSwapInstructionDataEncoder() {
  return (0, import_kit65.transformEncoder)(
    (0, import_kit65.getStructEncoder)([
      ...
      ["amount", (0, import_kit65.getU64Encoder)()],
      ["otherAmountThreshold", (0, import_kit65.getU64Encoder)()],
      ["sqrtPriceLimit", (0, import_kit65.getU128Encoder)()],
      ["amountSpecifiedIsInput", (0, import_kit65.getBooleanEncoder)()],
      ["aToB", (0, import_kit65.getBooleanEncoder)()]
    ]),
...
function getSwapInstructionDataDecoder() {
  return (0, import_kit65.getStructDecoder)([
    ...
    ["amount", (0, import_kit65.getU64Decoder)()],
    ["otherAmountThreshold", (0, import_kit65.getU64Decoder)()],
    ["sqrtPriceLimit", (0, import_kit65.getU128Decoder)()],
    ["amountSpecifiedIsInput", (0, import_kit65.getBooleanDecoder)()],
    ["aToB", (0, import_kit65.getBooleanDecoder)()]
  ]);
}
...
function getSwapV2DiscriminatorBytes() {
  return (0, import_kit66.fixEncoderSize)((0, import_kit66.getBytesEncoder)(), 8).encode(SWAP_V2_DISCRIMINATOR);
}
function getSwapV2InstructionDataEncoder() {
  return (0, import_kit66.transformEncoder)(
    (0, import_kit66.getStructEncoder)([
      ...
      ["amount", (0, import_kit66.getU64Encoder)()],
      ["otherAmountThreshold", (0, import_kit66.getU64Encoder)()],
      ["sqrtPriceLimit", (0, import_kit66.getU128Encoder)()],
      ["amountSpecifiedIsInput", (0, import_kit66.getBooleanEncoder)()],
      ["aToB", (0, import_kit66.getBooleanEncoder)()],
      [
        "remainingAccountsInfo",
        (0, import_kit66.getOptionEncoder)(getRemainingAccountsInfoEncoder())
      ]
    ]),
...
function getSwapV2InstructionDataDecoder() {
  return (0, import_kit66.getStructDecoder)([
    ...
    ["amount", (0, import_kit66.getU64Decoder)()],
    ["otherAmountThreshold", (0, import_kit66.getU64Decoder)()],
    ["sqrtPriceLimit", (0, import_kit66.getU128Decoder)()],
    ["amountSpecifiedIsInput", (0, import_kit66.getBooleanDecoder)()],
    ["aToB", (0, import_kit66.getBooleanDecoder)()],
    [
      "remainingAccountsInfo",
      (0, import_kit66.getOptionDecoder)(getRemainingAccountsInfoDecoder())
    ]
  ]);
}
...
function getTwoHopSwapInstructionDataEncoder() {
  return (0, import_kit67.transformEncoder)(
    (0, import_kit67.getStructEncoder)([
      ...
      ["amount", (0, import_kit67.getU64Encoder)()],
      ["otherAmountThreshold", (0, import_kit67.getU64Encoder)()],
      ["amountSpecifiedIsInput", (0, import_kit67.getBooleanEncoder)()],
      ["aToBOne", (0, import_kit67.getBooleanEncoder)()],
      ["aToBTwo", (0, import_kit67.getBooleanEncoder)()],
      ["sqrtPriceLimitOne", (0, import_kit67.getU128Encoder)()],
      ["sqrtPriceLimitTwo", (0, import_kit67.getU128Encoder)()]
    ]),
...
function getTwoHopSwapInstructionDataDecoder() {
  return (0, import_kit67.getStructDecoder)([
    ...
    ["amount", (0, import_kit67.getU64Decoder)()],
    ["otherAmountThreshold", (0, import_kit67.getU64Decoder)()],
    ["amountSpecifiedIsInput", (0, import_kit67.getBooleanDecoder)()],
    ["aToBOne", (0, import_kit67.getBooleanDecoder)()],
    ["aToBTwo", (0, import_kit67.getBooleanDecoder)()],
    ["sqrtPriceLimitOne", (0, import_kit67.getU128Decoder)()],
    ["sqrtPriceLimitTwo", (0, import_kit67.getU128Decoder)()]
  ]);
}
...
function getTwoHopSwapV2InstructionDataEncoder() {
  return (0, import_kit68.transformEncoder)(
    (0, import_kit68.getStructEncoder)([
      ...
      ["amount", (0, import_kit68.getU64Encoder)()],
      ["otherAmountThreshold", (0, import_kit68.getU64Encoder)()],
      ["amountSpecifiedIsInput", (0, import_kit68.getBooleanEncoder)()],
      ["aToBOne", (0, import_kit68.getBooleanEncoder)()],
      ["aToBTwo", (0, import_kit68.getBooleanEncoder)()],
      ["sqrtPriceLimitOne", (0, import_kit68.getU128Encoder)()],
      ["sqrtPriceLimitTwo", (0, import_kit68.getU128Encoder)()],
      [
        "remainingAccountsInfo",
        (0, import_kit68.getOptionEncoder)(getRemainingAccountsInfoEncoder())
      ]
    ]),
...
function getTwoHopSwapV2InstructionDataDecoder() {
  return (0, import_kit68.getStructDecoder)([
    ...
    ["amount", (0, import_kit68.getU64Decoder)()],
    ["otherAmountThreshold", (0, import_kit68.getU64Decoder)()],
    ["amountSpecifiedIsInput", (0, import_kit68.getBooleanDecoder)()],
    ["aToBOne", (0, import_kit68.getBooleanDecoder)()],
    ["aToBTwo", (0, import_kit68.getBooleanDecoder)()],
    ["sqrtPriceLimitOne", (0, import_kit68.getU128Decoder)()],
    ["sqrtPriceLimitTwo", (0, import_kit68.getU128Decoder)()],
    [
      "remainingAccountsInfo",
      (0, import_kit68.getOptionDecoder)(getRemainingAccountsInfoDecoder())
    ]
  ]);
}
...
async function fetchDecodedProgramAccounts(rpc, programAddress, filters, decoder) {
  ...
  const encoder = (0, import_kit70.getBase64Encoder)();
...
function feeTierWhirlpoolsConfigFilter(address) {
  return {
    memcmp: {
      offset: 8n,
      bytes: (0, import_kit71.getBase58Decoder)().decode((0, import_kit71.getAddressEncoder)().encode(address)),
      encoding: "base58"
    }
  };
}
function feeTierTickSpacingFilter(tickSpacing) {
  return {
    memcmp: {
      offset: 40n,
      bytes: (0, import_kit71.getBase58Decoder)().decode((0, import_kit71.getU16Encoder)().encode(tickSpacing)),
      encoding: "base58"
    }
  };
}
function feeTierFeeRateFilter(defaultFeeRate) {
  return {
    memcmp: {
      offset: 42n,
      bytes: (0, import_kit71.getBase58Decoder)().decode((0, import_kit71.getU16Encoder)().encode(defaultFeeRate)),
      encoding: "base58"
    }
  };
}
async function fetchAllFeeTierWithFilter(rpc, ...filters) {
  const discriminator = (0, import_kit71.getBase58Decoder)().decode(FEE_TIER_DISCRIMINATOR);
...
function positionWhirlpoolFilter(address) {
  return {
    memcmp: {
      offset: 8n,
      bytes: (0, import_kit72.getBase58Decoder)().decode((0, import_kit72.getAddressEncoder)().encode(address)),
      encoding: "base58"
    }
  };
}
...
function positionTickLowerIndexFilter(tickLowerIndex) {
  return {
    memcmp: {
      offset: 88n,
      bytes: (0, import_kit72.getBase58Decoder)().decode((0, import_kit72.getI32Encoder)().encode(tickLowerIndex)),
      encoding: "base58"
    }
  };
}
function positionTickUpperIndexFilter(tickUpperIndex) {
  return {
    memcmp: {
      offset: 92n,
      bytes: (0, import_kit72.getBase58Decoder)().decode((0, import_kit72.getI32Encoder)().encode(tickUpperIndex)),
      encoding: "base58"
    }
  };
}
async function fetchAllPositionWithFilter(rpc, ...filters) {
  const discriminator = (0, import_kit72.getBase58Decoder)().decode(POSITION_DISCRIMINATOR);
  const discriminatorFilter = {
    memcmp: {
      offset: 0n,
      bytes: discriminator,
...
function positionBundleMintFilter(address) {
  return {
    memcmp: {
      offset: 8n,
      bytes: (0, import_kit73.getBase58Decoder)().decode((0, import_kit73.getAddressEncoder)().encode(address)),
      encoding: "base58"
    }
  };
}
async function fetchAllPositionBundleWithFilter(rpc, ...filters) {
  const discriminator = (0, import_kit73.getBase58Decoder)().decode(
    POSITION_BUNDLE_DISCRIMINATOR
  );
  const discriminatorFilter = {
    memcmp: {
...
function tickArrayStartTickIndexFilter(startTickIndex) {
  return {
    memcmp: {
      offset: 8n,
      bytes: (0, import_kit74.getBase58Decoder)().decode((0, import_kit74.getI32Encoder)().encode(startTickIndex)),
      encoding: "base58"
    }
  };
}
function tickArrayWhirlpoolFilter(address) {
  return {
    memcmp: {
      offset: 9956n,
      bytes: (0, import_kit74.getBase58Decoder)().decode((0, import_kit74.getAddressEncoder)().encode(address)),
      encoding: "base58"
    }
  };
}
async function fetchAllTickArrayWithFilter(rpc, ...filters) {
  const discriminator = (0, import_kit74.getBase58Decoder)().decode(TICK_ARRAY_DISCRIMINATOR);
  const discriminatorFilter = {
    memcmp: {
      offset: 0n,
      bytes: discriminator,
...
function tokenBadgeWhirlpoolsConfigFilter(address) {
  return {
    memcmp: {
      offset: 8n,
      bytes: (0, import_kit75.getBase58Decoder)().decode((0, import_kit75.getAddressEncoder)().encode(address)),
      encoding: "base58"
    }
  };
}
...
async function fetchAllTokenBadgeWithFilter(rpc, ...filters) {
  const discriminator = (0, import_kit75.getBase58Decoder)().decode(TOKEN_BADGE_DISCRIMINATOR);
  const discriminatorFilter = {
    memcmp: {
      offset: 0n,
      bytes: discriminator,
...
function whirlpoolWhirlpoolConfigFilter(address) {
  return {
    memcmp: {
      offset: 8n,
      bytes: (0, import_kit76.getBase58Decoder)().decode((0, import_kit76.getAddressEncoder)().encode(address)),
      encoding: "base58"
    }
  };
}
function whirlpoolTickSpacingFilter(tickSpacing) {
  return {
    memcmp: {
      offset: 41n,
      bytes: (0, import_kit76.getBase58Decoder)().decode((0, import_kit76.getU16Encoder)().encode(tickSpacing)),
      encoding: "base58"
    }
  };
}
function whirlpoolFeeRateFilter(defaultFeeRate) {
  return {
    memcmp: {
      offset: 45n,
      bytes: (0, import_kit76.getBase58Decoder)().decode((0, import_kit76.getU16Encoder)().encode(defaultFeeRate)),
      encoding: "base58"
    }
  };
}
function whirlpoolProtocolFeeRateFilter(protocolFeeRate) {
  return {
    memcmp: {
      offset: 47n,
      bytes: (0, import_kit76.getBase58Decoder)().decode((0, import_kit76.getU16Encoder)().encode(protocolFeeRate)),
      encoding: "base58"
    }
  };
}
function whirlpoolTokenMintAFilter(tokenMintA) {
  return {
    memcmp: {
      offset: 101n,
      bytes: (0, import_kit76.getBase58Decoder)().decode((0, import_kit76.getAddressEncoder)().encode(tokenMintA)),
      encoding: "base58"
    }
  };
}
function whirlpoolTokenVaultAFilter(tokenVaultA) {
  return {
    memcmp: {
      offset: 133n,
      bytes: (0, import_kit76.getBase58Decoder)().decode((0, import_kit76.getAddressEncoder)().encode(tokenVaultA)),
      encoding: "base58"
    }
  };
}
function whirlpoolTokenMintBFilter(tokenMintB) {
  return {
    memcmp: {
      offset: 181n,
      bytes: (0, import_kit76.getBase58Decoder)().decode((0, import_kit76.getAddressEncoder)().encode(tokenMintB)),
      encoding: "base58"
    }
  };
}
function whirlpoolTokenVaultBFilter(tokenVaultB) {
  return {
    memcmp: {
      offset: 213n,
      bytes: (0, import_kit76.getBase58Decoder)().decode((0, import_kit76.getAddressEncoder)().encode(tokenVaultB)),
      encoding: "base58"
    }
  };
}
function whirlpoolRewardMint1Filter(rewardMint1) {
  return {
    memcmp: {
      offset: 269n,
      bytes: (0, import_kit76.getBase58Decoder)().decode((0, import_kit76.getAddressEncoder)().encode(rewardMint1)),
      encoding: "base58"
    }
  };
}
function whirlpoolRewardVault1Filter(rewardVault1) {
  return {
    memcmp: {
      offset: 301n,
      bytes: (0, import_kit76.getBase58Decoder)().decode(
        (0, import_kit76.getAddressEncoder)().encode(rewardVault1)
      ),
      encoding: "base58"
    }
  };
...
function whirlpoolRewardMint2Filter(rewardMint2) {
  return {
    memcmp: {
      offset: 397n,
      bytes: (0, import_kit76.getBase58Decoder)().decode((0, import_kit76.getAddressEncoder)().encode(rewardMint2)),
      encoding: "base58"
    }
  };
}
function whirlpoolRewardVault2Filter(rewardVault2) {
  return {
    memcmp: {
      offset: 429n,
      bytes: (0, import_kit76.getBase58Decoder)().decode(
        (0, import_kit76.getAddressEncoder)().encode(rewardVault2)
      ),
      encoding: "base58"
    }
  };
...
function whirlpoolRewardMint3Filter(rewardMint3) {
  return {
    memcmp: {
      offset: 525n,
      bytes: (0, import_kit76.getBase58Decoder)().decode((0, import_kit76.getAddressEncoder)().encode(rewardMint3)),
      encoding: "base58"
    }
  };
}
function whirlpoolRewardVault3Filter(rewardVault3) {
  return {
    memcmp: {
      offset: 557n,
      bytes: (0, import_kit76.getBase58Decoder)().decode(
        (0, import_kit76.getAddressEncoder)().encode(rewardVault3)
      ),
      encoding: "base58"
    }
  };
...
async function fetchAllWhirlpoolWithFilter(rpc, ...filters) {
  const discriminator = (0, import_kit76.getBase58Decoder)().decode(WHIRLPOOL_DISCRIMINATOR);
  const discriminatorFilter = {
    memcmp: {
      offset: 0n,
      bytes: discriminator,
...
function whirlpoolsConfigFeeAuthorityFilter(feeAuthority) {
  return {
    memcmp: {
      offset: 8n,
      bytes: (0, import_kit77.getBase58Decoder)().decode(
        (0, import_kit77.getAddressEncoder)().encode(feeAuthority)
      ),
      encoding: "base58"
    }
  };
...
function whirlpoolsConfigCollectProtocolFeesAuthorityFilter(collectProtocolFeesAuthority) {
  return {
    memcmp: {
      offset: 40n,
      bytes: (0, import_kit77.getBase58Decoder)().decode(
        (0, import_kit77.getAddressEncoder)().encode(collectProtocolFeesAuthority)
      ),
      encoding: "base58"
    }
  };
...
function whirlpoolsConfigRewardEmissionsSuperAuthorityFilter(rewardEmissionsSuperAuthority) {
  return {
    memcmp: {
      offset: 72n,
      bytes: (0, import_kit77.getBase58Decoder)().decode(
        (0, import_kit77.getAddressEncoder)().encode(rewardEmissionsSuperAuthority)
      ),
      encoding: "base58"
    }
  };
...
function whirlpoolsConfigDefaultProtocolFeeRateFilter(defaultFeeRate) {
  return {
    memcmp: {
      offset: 104n,
      bytes: (0, import_kit77.getBase58Decoder)().decode((0, import_kit77.getU16Encoder)().encode(defaultFeeRate)),
      encoding: "base58"
    }
  };
}
async function fetchAllWhirlpoolsConfigWithFilter(rpc, ...filters) {
  const discriminator = (0, import_kit77.getBase58Decoder)().decode(
    WHIRLPOOLS_CONFIG_DISCRIMINATOR
  );
  const discriminatorFilter = {
    memcmp: {
...
function whirlpoolsConfigExtensionWhirlpoolsConfigFilter(address) {
  return {
    memcmp: {
      offset: 8n,
      bytes: (0, import_kit78.getBase58Decoder)().decode((0, import_kit78.getAddressEncoder)().encode(address)),
      encoding: "base58"
    }
  };
}
function whirlpoolsConfigExtensionConfigExtensionAuthorityFilter(configExtensionAuthority) {
  return {
    memcmp: {
      offset: 40n,
      bytes: (0, import_kit78.getBase58Decoder)().decode(
        (0, import_kit78.getAddressEncoder)().encode(configExtensionAuthority)
      ),
      encoding: "base58"
    }
  };
...
function whirlpoolsConfigExtensionConfigTokenBadgeAuthorityFilter(configTokenBadgeAuthority) {
  return {
    memcmp: {
      offset: 72n,
      bytes: (0, import_kit78.getBase58Decoder)().decode(
        (0, import_kit78.getAddressEncoder)().encode(configTokenBadgeAuthority)
      ),
      encoding: "base58"
    }
  };
...
async function fetchAllWhirlpoolsConfigExtensionWithFilter(rpc, ...filters) {
  const discriminator = (0, import_kit78.getBase58Decoder)().decode(
    WHIRLPOOLS_CONFIG_EXTENSION_DISCRIMINATOR
  );
  const discriminatorFilter = {
    memcmp: {
...
async function getFeeTierAddress(whirlpoolsConfig, tickSpacing) {
  return await (0, import_kit79.getProgramDerivedAddress)({
    ...
    seeds: [
      "fee_tier",
      (0, import_kit79.getAddressEncoder)().encode(whirlpoolsConfig),
      (0, import_kit79.getU16Encoder)().encode(tickSpacing)
    ]
  });
}
...
async function getOracleAddress(whirlpool) {
  return await (0, import_kit80.getProgramDerivedAddress)({
    programAddress: WHIRLPOOL_PROGRAM_ADDRESS,
    seeds: ["oracle", (0, import_kit80.getAddressEncoder)().encode(whirlpool)]
  });
}
...
async function getPositionAddress(positionMint) {
  return await (0, import_kit81.getProgramDerivedAddress)({
    programAddress: WHIRLPOOL_PROGRAM_ADDRESS,
    seeds: ["position", (0, import_kit81.getAddressEncoder)().encode(positionMint)]
  });
}
...
async function getPositionBundleAddress(positionBundleMint) {
  return await (0, import_kit82.getProgramDerivedAddress)({
    programAddress: WHIRLPOOL_PROGRAM_ADDRESS,
    seeds: ["position_bundle", (0, import_kit82.getAddressEncoder)().encode(positionBundleMint)]
  });
}
async function getBundledPositionAddress(positionBundleAddress, bundleIndex) {
  return await (0, import_kit82.getProgramDerivedAddress)({
    ...
    seeds: [
      "bundled_position",
      (0, import_kit82.getAddressEncoder)().encode(positionBundleAddress),
...
async function getTickArrayAddress(whirlpool, startTickIndex) {
  return await (0, import_kit83.getProgramDerivedAddress)({
    programAddress: WHIRLPOOL_PROGRAM_ADDRESS,
    seeds: [
      "tick_array",
      (0, import_kit83.getAddressEncoder)().encode(whirlpool),
      `${startTickIndex}`
    ]
  });
}
...
async function getTokenBadgeAddress(whirlpoolsConfig, tokenMint) {
  return await (0, import_kit84.getProgramDerivedAddress)({
    programAddress: WHIRLPOOL_PROGRAM_ADDRESS,
    seeds: [
      "token_badge",
      (0, import_kit84.getAddressEncoder)().encode(whirlpoolsConfig),
      (0, import_kit84.getAddressEncoder)().encode(tokenMint)
    ]
  });
}
...
async function getWhirlpoolAddress(whirlpoolsConfig, tokenMintA, tokenMintB, tickSpacing) {
  return await (0, import_kit85.getProgramDerivedAddress)({
    programAddress: WHIRLPOOL_PROGRAM_ADDRESS,
    seeds: [
      "whirlpool",
      (0, import_kit85.getAddressEncoder)().encode(whirlpoolsConfig),
      (0, import_kit85.getAddressEncoder)().encode(tokenMintA),
      (0, import_kit85.getAddressEncoder)().encode(tokenMintB),
      (0, import_kit85.getU16Encoder)().encode(tickSpacing)
    ]
  });
}
...
async function getWhirlpoolsConfigExtensionAddress(configAddress) {
  return await (0, import_kit86.getProgramDerivedAddress)({
    programAddress: WHIRLPOOL_PROGRAM_ADDRESS,
    seeds: ["config_extension", (0, import_kit86.getAddressEncoder)().encode(configAddress)]
  });
}
