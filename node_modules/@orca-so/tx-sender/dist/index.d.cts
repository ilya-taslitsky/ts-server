import { IInstruction, TransactionSigner, Address, FullySignedTransaction, TransactionWithLifetime, KeyPairSigner, Commitment, Signature, Rpc, SolanaRpcApi } from '@solana/web3.js';
...
declare function setRpc(url: string, supportsPriorityFeePercentile?: boolean): Promise<void>;
